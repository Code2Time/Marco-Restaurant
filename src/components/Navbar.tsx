...
function Navbar() {
  return (
    <div className="navbar-container w-full h-auto">
    <div className="marco-icon w-full h-auto absolute top-4 ">
      <img className='w-24 mx-auto' 
      src={logo} 
      alt="marco-logo" />
    </div>
    <div className='nav w-full h-auto bg-bg-gray-2 absolute top-[130px]'>
    <Disclosure dir='rtl' id="nav-container" as="nav" className="sticky top-0">
      {({ open }) => (
        <div>
            ...
            <div className="relative flex h-16 items-center justify-center">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  <h1 className='block sm:hidden poppins-4 mx-2'>
                    menue
                  </h1>
                  <Transition
                    as={Fragment}
